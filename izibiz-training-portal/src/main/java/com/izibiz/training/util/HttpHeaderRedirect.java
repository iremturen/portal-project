...
public class HttpHeaderRedirect extends HttpServletResponseWrapper {
	...
	/*
	 * @Override public void sendRedirect(String location) throws IOException { if
	 * (!location.startsWith("http")) location = "https://" + applicationUrl + ":" +
	 * port + location; location = location.replaceFirst("http:", "https:");
